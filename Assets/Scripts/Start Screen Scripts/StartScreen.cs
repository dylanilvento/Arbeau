...
public class StartScreen : MonoBehaviour {
	...
	public GameObject arbeauLogo, menu;

	public AudioSource hdd, typing, boot;
	...
	IEnumerator MoveLogo () {
		for (int ii = 0; ii < 40; ii++) {
			arbeauLogo.transform.position = new Vector2(arbeauLogo.transform.position.x, arbeauLogo.transform.position.y + Screen.height / 240f);
