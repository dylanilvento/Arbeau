...
public class GameManager : MonoBehaviour
{
    ...
    public GameObject retrievalWin,
        distrWin,
        introWin,
        gameOverWin; //retrieval and distribution
    ...
    IEnumerator CheckTasks()
    {
        ...
        foreach (Task task in tasks)
        {
            ...
            {
                Blink blink = GameObject
                    .Find(currDist.name.ToUpper() + " Menu Bar Background")
                    .GetComponent<Blink>();
                blink.BlinkWin();
                if (!arbeauOff)
